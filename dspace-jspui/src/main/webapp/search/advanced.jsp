...
%>
         ...
         <table cellspacing="2" border="0" width="80%">
		  <tr>
            ...
            <td width="12%" align="left" valign="top"></td>
              <td width="20%" align="left" valign="top" nowrap="nowrap">
                ...
                <label for="tfield1"><fmt:message key="jsp.search.advanced.type"/></label> <br/>
                  <select class="form-control" name="field1" id="tfield1">
					<%
            ...
            <td align="left" valign="top" nowrap="nowrap" width="68%">
                ...
                <input class="form-control" type="text" name="query1" id="tquery1" value="<%=StringEscapeUtils.escapeHtml(query1)%>" size="30" />
                <br/>
              <p/>
            </td>
          </tr>
          <tr>
            <td width="12%" align="left" valign="top">
              <select class="form-control" name="conjunction1">
		...
		<option value="OR" <%= conjunction1.equals("OR") ? "selected=\"selected\"" : "" %>> <fmt:message key="jsp.search.advanced.logical.or" /> </option>
            ...
            <td align="left" valign="top" nowrap="nowrap" width="68%">
              <input class="form-control" type="text" name="query2" value="<%=StringEscapeUtils.escapeHtml(query2)%>" size="30"/>
            </td>
          </tr>
          <tr>
            <td width="12%" align="left" valign="top">
              <select class="form-control" name="conjunction2">
            ...
            <td align="left" valign="top" nowrap="nowrap" width="68%">
              <input class="form-control" type="text" name="query3" value="<%=StringEscapeUtils.escapeHtml(query3)%>" size="30"/>
            </td>
  ...
  <tr>
    <td valign="bottom" align="right" nowrap="nowrap">
      ...
      <input class="form-control" type="submit" name="submit" value="<fmt:message key="jsp.search.advanced.search2"/>" />
            &nbsp;  &nbsp; &nbsp;
      <%-- <input type="reset" name="reset" value=" Clear "> --%>
      <input class="form-control" type="reset" name="reset" value=" <fmt:message key="jsp.search.advanced.clear"/>" />
    </td>
  </tr>
</table>
</td>
