...
%>                                </select><br/>
                                ...
                                <input class="form-control" type="text" size="50" id="query" name="query" value="<%= (query==null ? "" : Utils.addEntities(query)) %>"/>
...
<% if (appliedFilters.size() > 0 ) { %>                                
		...
		<%
			...
			for (String[] filter : appliedFilters)
			{
				...
				<select class="form-control" id="filter_type_<%=idx %>" name="filter_type_<%=idx %>">
				<%
				...
				<input class="form-control" type="text" id="filter_value_<%=idx %>" name="filter_value_<%=idx %>" value="<%= Utils.addEntities(filter[2]) %>" size="45"/>
